...
class Kernel {
  ...
  public:
     ...
     *
     * Takes in the GPU device, the filename of the Metal library, and the name
     * of the function and creates a new Kernel object and MTL::Library. Also
     * calls useFunction with the function name
     *
     * @param gpu The GPU device
     * @param filename The filename of the Metal library
     ...
     *
     */
    ~Kernel() { this->library->autorelease(); }

    /**
     * @brief Get the names of the functions in the library
     *
     * @return A vector of strings containing the names of the functions in the
     * library
     *
     */
     ...
     *
     * Takes in the name of a function in the library and creates a new function
     ...
     *
     */
    MTL::ComputePipelineState *getPLS() { return this->pipeline; }
};
